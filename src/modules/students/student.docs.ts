...
export const StudentDocs = {
  ...
  createStudentBatch: {
    detail: {
      ...
      description: "Create multiple students with the provided information from CSV or Excel file",
      tags: ["Students"],
    },
    body: StudentBatchUploadDTO,
    response: {
      201: mapResponse(BatchStudentResponseSchema),
    },
  },
};
